...
\caption[The steps of Monte Carlo tree search]{The steps of Monte Carlo tree search \cite{Chaslot2008}. \todo[inline]{Fix MCTS diagram.}}
\label{fig:MCTS}
\end{wrapfigure}
...
\todo[inline]{Finish machine learning section}
