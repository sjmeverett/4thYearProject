...
\caption[Monte Carlo tree search algorithm]{Monte Carlo tree search algorithm \cite{Chaslot2008}. \todo[inline]{Fix MCTS diagram.}}
\label{fig:MCTS}
\end{wrapfigure}
